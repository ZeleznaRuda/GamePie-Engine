...
class Image:
    ...
    def __draw_outline_image(self):
        image(surface=self.surface, image=self.texture, color=self.__outline_color,rect=(self.rect.x-self.__outline_size,self.rect.y-self.__outline_size,self.rect.width+self.__outline_size*2,self.rect.height+self.__outline_size*2),flip=self._flip, angle=self._angle,tint_mode=self._tint_mode)
