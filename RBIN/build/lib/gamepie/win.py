...
import datetime
class Window:
    def __init__(self,icon=ICON16,title="GamePie", size=(800,500),fps_limit=60, flags=None,monitor=0, vsync=False, screenshot=True):
    ...
    def _get_screenshot_folder(self):
        folder = Path(__file__).parent.parent / "screenshots"
    ...
    def run(self):
        while self.running:
            ...
            if self.screenshot and key.is_down("f2"):
                ...
                file_path = folder / f"screenshot{formatted_time}{id(self)}.jpg"
